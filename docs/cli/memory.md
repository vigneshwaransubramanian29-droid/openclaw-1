...
- When `memorySearch.sqliteMemory.enabled = true`, `memory status` also shows the structured
  SQLite sidecar path, row counts, degradation state, and persisted timing metrics.
